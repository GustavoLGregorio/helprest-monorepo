	...
	const temp_places: TempPlacesType[] = [
		{
			...
			flags: ["gluten", "vegan"],
			logo_empresa: "@/assets/images/places/1.jpeg",
			fotos: ["@/assets/images/places/10.jpeg"],
		},
		{
			id: 1,
			empresa: "Espaço Vegano",
			flags: ["gluten", "vegan"],
			logo_empresa: "@/assets/images/places/2.jpeg",
			fotos: ["@/assets/images/places/10.jpeg"],
		},
		{
			id: 2,
			...
			flags: ["gluten", "vegan"],
			logo_empresa: "@/assets/images/places/3.jpeg",
			fotos: ["@/assets/images/places/10.jpeg"],
		},
		{
			id: 3,
			...
			flags: ["gluten", "vegan"],
			logo_empresa: "@/assets/images/places/4.jpeg",
			fotos: ["@/assets/images/places/10.jpeg"],
		},
		{
			id: 4,
			...
			flags: ["gluten", "vegan"],
			logo_empresa: "@/assets/images/places/5.jpeg",
			fotos: ["@/assets/images/places/10.jpeg"],
		},
		{
			id: 5,
			...
			flags: ["gluten", "vegan"],
			logo_empresa: "@/assets/images/places/6.jpeg",
			fotos: ["@/assets/images/places/10.jpeg"],
		},
	];
